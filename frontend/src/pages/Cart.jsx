      ...
      <div>
        {
          cartData.map((item,index)=>{
            ...
            return (
              <div key={index} className='py-4 border-t border-b border-gray-300 text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] text-center gap-4'>
                ...
                <img onClick={()=>updateQuantity(item._id,item.size,0)} className='w-4 mr-4 sm:w-5 m-7 cursor-pointer' src={assets.bin_icon} alt="" />
              </div>
            )
